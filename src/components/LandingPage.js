...
const LandingPage = ({ className = "" }) => {
  ...
  return (
    <section
      className={`self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-5 box-border max-w-full shrink-0 text-left text-21xl text-white font-montserrat ${className}`}
    >
      <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[71.3px] box-border relative gap-[69px] max-w-full mq750:gap-[34px] mq750:pb-[46px] mq750:box-border mq450:gap-[17px]">
        ...
        <div className="w-[1339px] flex flex-row items-start justify-start py-0 px-[76px] box-border max-w-full lg:pl-[38px] lg:pr-[38px] lg:box-border">
          <div className="flex-1 flex flex-row items-start justify-start [row-gap:20px] max-w-full mq1050:flex-wrap">
            <div className="h-[511.7px] flex-1 relative min-w-[504px] max-w-full mq750:min-w-full">
              ...
              <img
                className="absolute top-[0px] left-[152px] w-[472px] h-[466px] object-contain z-[4]"
                loading="lazy"
                alt=""
                src="/assets-2@2x.png"
              />
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full mt-[-73px] text-base font-dm-sans">
        <SearchBox />
      </div>
    </section>
  );
